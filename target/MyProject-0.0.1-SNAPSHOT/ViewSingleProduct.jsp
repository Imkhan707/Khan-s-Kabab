...
<body style="margin: auto; width: 80%;">
	...
	<table class="table table-striped" style="font-size: 20px; font-weight: bold;">
		<tbody>
			...
			<tr>
				<td colspan="2">
					<center>
						<img src="${Product.getImagePath()}" style="max-width: 500px;" class="img img-thumbnail" />
					</center>
				</td>
			</tr>
			<tr>
	...
	<form action="AddCart" method="post">
		...
		<input type="email" name="email" class="form-control"placeholder="Enter Email" value="${loggedInUserEmail}"> 
		
		<br> 
		
		<a href="ViewCart.jsp" class="btn btn-primary">view</a>
