		...
		<tbody>
			...
			<c:forEach var="x" items="${categories}">
				...
				<tr>
					...
					<a href="ViewProductsByCategory.jsp?category_id=${x.getId()}" class="btn btn-danger">Delete</a></td>					<td><a href="UpdateCategory.jsp?id=${x.getId()}" class="btn btn-success">Update</a></td>
