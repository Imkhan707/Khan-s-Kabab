...
<body style="margin: auto; width: 80%;">
	...
	<a href="ViewCart.jsp?email=${email}" class="btn btn-primary">Back To Cart</a>

	<a href="ViewInvoice.jsp?email=<%=request.getParameter("email")%>" class="btn btn-danger" style="float: right;">View Invoice</a>
