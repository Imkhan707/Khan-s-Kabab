...
<body style="margin: auto; width: 80%;">
	...
	<h1>
		Invoice:<%=request.getParameter("email")%></h1>
	<hr>
	...
	<table class="table table-striped" style="font-size: 20px; font-weight: bold;">
			<tbody>
				...
				<tr>
					<td>Ship To</td>
					<td><textarea disabled="disabled" class="form-control" name="shipTo" style="resize: none;" placeholder="Enter Shipping Address">${cartAddress[0]}</textarea>
					</td>
				</tr>
				<tr>
					<td>Bill To</td>
					<td><textarea disabled="disabled" class="form-control" name="billTo" style="resize: none;" placeholder="Enter Billing Address">${cartAddress[1]}</textarea>
					</td>
				</tr>
		...
		<tbody>
			...
			<c:forEach var="x" items="${cart}">
				...
				<tr>
					...
					<td><img src="${x.getProduct().getImagePath()}" class="img img-thumbnail" style="max-width: 150px;"></td>
	...
	<a href="ConfirmOrder.jsp?email=<%=request.getParameter("email")%>" class="btn btn-danger" style="float: right;">Confirm Order</a>
